...
public class FsdAsm implements Asm {
    private Reg src, dest;
    private int offset;

    public FsdAsm(Reg src, Reg dest) {
        this(src, dest, 0);
    }

    public FsdAsm(Reg src, Reg dest, int offset) {
        this.src = src;
        this.dest = dest;
        this.offset = offset;
    }
    ...
    public String toString() {
        return String.format("fsd %s,%d(%s)", src, offset, dest);
    }
}
